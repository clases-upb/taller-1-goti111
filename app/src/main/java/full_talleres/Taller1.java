    ...
    */
     public static String Convertir_km_seg(int velocidad_km_seg) {
        try {
            ...
            float metros_por_segundo = velocidad_km_seg * METROS_POR_KM;
            float metros_por_hora = metros_por_segundo * SEGUNDOS_POR_HORA;
...
public static double Convertir_cent_far(double temperatura_grados_C){
   ...
   */
   public static int Calcular_segs(short nro_dias, short nro_horas, short nro_mins, short nro_segs) {
    try {
        final int segs_x_dia = 86400;
        final int segs_x_hora = 3600;
        final int segs_x_min = 60;
        ...
        int total_segs = segundos_x_dia_total + segundos_x_hora_total + segundos_x_min_total + nro_segs;
        return total_segs;
   ...
   Si hay algún error, devuelva en un string "Error en la función Calcular_peso_carga"*/
    ...
    try {
        ...
        float kg_por_TON = 1000f;
        float peso_neto_kg = peso_neto_carga * kg_por_TON;
        float peso_neto_TON = peso_neto_carga;

        String mensaje_final = (peso_neto_kg + " kilos - " + peso_neto_TON + " toneladas");
   ...
   */
    ...
    try {
        ...
        final float FACTOR_LUNA = 0.165f;
